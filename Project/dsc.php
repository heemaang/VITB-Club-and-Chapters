...
<section class="gallery" id="gallery">
   ...
   <u><h1 class="heading" style="color: blue">Data Science Club</h1></u>
    ...
    <div class="box-container">
        ...
        <h3>Dr. Abha Trivedi(100259) </h3>
        <h3 style="font-style: bold">Room no.: C-530</h3>
        <h3 style="font-style: bold">Mobile Number / Mail ID: </h3>
        <h3>7607537134 / abhatrivedi2021@vitbhopal.ac.in</h3>
        <h3>     </h3>
...
<section class="gall" id="gall">
    ...
    <div class="box-container">
        ...
        <h3>Dr. Pon Harshavardhan (100122)</h3>
        <h3 style="font-style: bold">Room no.: FC202 </h3>
        <h3 style="font-style: bold">Mobile Number / Mail ID: </h3>
        <h3>9840768153 / pon.harshavardhanan@vitbhopal.ac.in</h3>
