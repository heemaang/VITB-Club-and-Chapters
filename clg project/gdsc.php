...
<section class="gallery" id="gallery">
   ...
   <u><h1 class="heading" style="color: blue">Google Developer Student Clubs</h1></u>
    ...
    <div class="box-container">
        ...
        <h3>Dr. Kamlesh Chandravanshi (100360) </h3>
        <h3 style="font-style: bold">Room no.: 4B</h3>
        <h3 style="font-style: bold">Mobile Number / Mail ID: </h3>
        <h3>9009217763 / kamlesh.chandravanshi@vitbhopal.ac.in</h3>
        <h3>     </h3>
...
<section class="gall" id="gall">
    ...
    <div class="box-container">
        ...
        <h3> Dr. Gaurav Soni (100382)</h3>
        <h3 style="font-style: bold">Room no.: FC-408-B </h3>
        <h3 style="font-style: bold">Mobile Number / Mail ID: </h3>
        <h3>9826018671 / gaurav.soni@vitbhopal.ac.in</h3>
